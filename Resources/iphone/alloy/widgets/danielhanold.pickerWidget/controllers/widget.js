    ...
    function populatePicker() {
        switch (args.type) {
          ...
          case "date-picker":
            ...
            args.pickerParams = args.pickerParams || {};
            _.isDate(args.pickerParams.minDate) && picker.setMinDate(args.pickerParams.minDate);
            _.isDate(args.pickerParams.maxDate) && picker.setMaxDate(args.pickerParams.maxDate);
            _.isDate(args.pickerParams.value) && picker.setValue(args.pickerParams.value);
        }
    }
    ...
    function done() {
        ...
        switch (args.type) {
          ...
          case "age-range":
            ...
            if (_.isNumber(args.pickerParams.minDifference) && Number(args.pickerParams.minDifference) > numberHigh - numberLow) {
                Ti.UI.createAlertDialog({
                    title: "Error",
